...
Sou especialista no ecossistema **Front-end (React, Next.js e Angular)**, focado na construção de interfaces de alta performance e arquiteturas escaláveis (Microfrontends e Monólitos Modulares). No **Back-end**, atuo no desenvolvimento de APIs robustas utilizando principalmente **Node.js (Fastify) e Java (Spring Boot)**.
